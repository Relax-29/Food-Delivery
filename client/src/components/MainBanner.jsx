...
function MainBanner() {
  return (
    <div className='relative'>
        ...
        <div className='absolute insert-0 flex flex-col item-center md:item-start justify-end md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
            <h1 className='text-3xl md:text-4xl font-bold lg:text-5xl text-center md:text-left max-w-72 md:max-w-80 lg:max-w-105 leading-tight lg-leading-15'>Freshness You Can Trust, Savings You will Love!</h1>
